 ...
 *
 * $Date: 2008-05-02 21:16:57 +0000 (Fri, 02 May 2008) $
 * $Rev: 5388 $
 */
;(function($) {
	...
	$.extend($.ui.mouseInteraction.prototype, {
		...
		drag: function(e) {
			...
			if ($.browser.msie && !e.button) {
				// IE mouseup check
				return this.stop.apply(this, [e]);
			}
			
			if(!this.initialized && (Math.abs(this._MP.left-e.pageX) >= o.distance || Math.abs(this._MP.top-e.pageY) >= o.distance)) {
				if(this.options.start) {
					this.options.start.call(this.options.executor || this, e, this.element);
				}
			...
			if(o.drag) {
				o.drag.call(this.options.executor || this, e, this.element);
			}
			return false;
